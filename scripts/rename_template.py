...
It renames all the occurrences of StrideSim (in files, directories, etc.) to the new project name.
"""
...
if __name__ == "__main__":
    ...
    if proceed.lower() == "y":
        # rename the StrideSim folder
        os.rename(
            os.path.join(root_dir_path, "exts", "StrideSim", "StrideSim"),
            os.path.join(root_dir_path, "exts", "StrideSim", new_name),
        )
        os.rename(os.path.join(root_dir_path, "exts", "StrideSim"), os.path.join(root_dir_path, "exts", new_name))
