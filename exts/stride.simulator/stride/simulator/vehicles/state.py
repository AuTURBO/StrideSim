...
from stride.simulator.common.coordinate_system import rot_ENU_to_NED, rot_FLU_to_FRD
...
class State:
    ...
    Note:
        - position - A numpy array with the [x,y,z] of the vehicle expressed
                    in the inertial frame according to an ENU convention.
        - orientation - A numpy array with the quaternion [qx, qy, qz, qw] that encodes
                        the attitude of the vehicle's FLU body frame, relative to an ENU inertial frame,
                        expressed in the ENU inertial frame.
        - linear_velocity - A numpy array with [vx,vy,vz] that defines the velocity of the vehicle expressed
                            in the inertial frame according to an ENU convention.
        - linear_body_velocity - A numpy array with [u,v,w] that defines the velocity of the vehicle expressed
                                in the FLU body frame.
        - angular_velocity - A numpy array with [p,q,r] with the angular velocity of the vehicle's FLU body frame,
                            relative to an ENU inertial frame, expressed in the FLU body frame.
        - linear acceleration - An array with [x_ddot, y_ddot, z_ddot] with the acceleration of the vehicle expressed
                                in the inertial frame according to an ENU convention.
    """
    ...
    def __init__(self):
        ...
        # expressed in the inertial frame. This quaternion should follow the convention [qx, qy, qz, qw],
        # such that "no rotation" equates to the quaternion=[0, 0, 0, 1]
    ...
    def get_position_ned(self):
        ...
        Returns:
            np.ndarray: A numpy array with the [x,y,z] of the vehicle expressed
                        in the inertial frame according to an NED convention.
        """
    ...
    def get_attitude_ned_frd(self):
        ...
        Returns:
            np.ndarray: A numpy array with the quaternion [qx, qy, qz, qw] that encodes
    ...
    def get_linear_body_velocity_ned_frd(self):
        ...
        converts the linear body velocity of the vehicle it to the NED-FRD convention used by PX4 and
        other onboard flight controllers

        Returns:
            np.ndarray: A numpy array with [u,v,w] that defines the velocity of the vehicle expressed
    ...
    def get_linear_velocity_ned(self):
        ...
        Returns:
            np.ndarray: A numpy array with [vx,vy,vz] that defines the velocity of the vehicle expressed
                        in the inertial frame according to a NED convention.
        """
    ...
    def get_angular_velocity_frd(self):
        ...
        Returns:
            np.ndarray: A numpy array with [p,q,r] with the angular velocity of the vehicle's FRD body frame,
                    `   relative to an NED inertial frame, expressed in the FRD body frame.
        """
    ...
    def get_linear_acceleration_ned(self):
        ...
        Returns:
            np.ndarray: An array with [x_ddot, y_ddot, z_ddot] with the acceleration of the vehicle expressed
                        in the inertial frame according to an NED convention.
        """
